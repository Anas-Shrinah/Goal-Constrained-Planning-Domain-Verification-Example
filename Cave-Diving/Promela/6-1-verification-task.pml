...
Section 6 - verification task 1.
Unconstrained verification with only the safety property.
...
Spin returns unreachable counterexample: <prepare-tank, enter-water, swim(L0 , L1 )> */
ltl p0 {!(<>((fullTanksD == 0) && (fulltanksL[location] == 0)  && (location != 0)))}
