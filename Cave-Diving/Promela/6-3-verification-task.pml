...
Section 6 - verification task 3.
Verification using Spin with both safety property and proper goal, but without the augmented model M'.
...
Spin returns unreachable counterexample:<prepare-tank, prepare-tank, prepare-tank, prepare-tank, enter-water, swim(L0 , L1),
take-photo, swim(L1 , L0), decompress, enter water, swim(L0 , L1)>*/
